        ...
        <div className="userShow">
          <div className="userShowTop">
            ...
            <div className="userShowTopTitle">
              <span className="userShowUsername">Ashwitha</span>
              <span className="userShowUserTitle">Swimmer</span>
            </div>
          </div>
          <div className="userShowBottom">
            ...
            <div className="userShowInfo">
              ...
              <span className="userShowInfoTitle">Aashw123</span>
            </div>
            <div className="userShowInfo">
              < CalendarToday className="userShowIcon" />
              <span className="userShowInfoTitle">10.07.98</span>
            </div>
            <span className="userShowTitle">Contact Details</span>
            <div className="userShowInfo">
              <PhoneAndroid className="userShowIcon" />
              <span className="userShowInfoTitle">+918015643896</span>
            </div>
            <div className="userShowInfo">
              <MailOutline className="userShowIcon" />
              <span className="userShowInfoTitle">ammursa@gmail</span>
            </div>
            <div className="userShowInfo">
              <LocationSearching className="userShowIcon" />
              <span className="userShowInfoTitle">Ettimadai-India</span>
            </div>
          </div>
        </div>
